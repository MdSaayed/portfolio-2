...
const Banner = () => {
    return (
        <div className='bg-[#FFFDD8]'>
            <div className='h-[100vh] w-full bg-cover grid grid-cols-1  md:grid-cols-2 items-center justify-between max-w-6xl mx-auto px-2 md:px-0'>
                <div className='order-2 md:order-1 md:items-start items-center justify-start md:justify-center md:items-start flex flex-col'>
                    ...
                    <h1 className='font-extrabold text-5xl'>NEW SMART PHONE</h1>
