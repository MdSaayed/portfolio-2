...
const Product = ({ product }) => {
    ...
    return (
        <div className="border rounded-sm py-4 relative">
            <div className="flex justify-center">
                <img className="w-2/3" src={productImgUrl} alt="" />
            ...
            <div className="flex flex-col items-center justify-between px-4">
                ...
                <Link className='text-white bg-blue-700 py-1 mt-1 rounded-sm px-6'>View Details</Link>
            </div>
        </div>
    );
};
